    ...
    return (
        <View style={header.container}>
            ...
            <View style={header.containerIcons}>
                {!hiddenIcons.includes("search") && (
                    <Search color={iconColor} size={20} />
                )}
                {!hiddenIcons.includes("refresh") && (
                    <RefreshCcw color={iconColor} size={16} />
                )}
                {!hiddenIcons.includes("plus") && (
                    <CirclePlus color={iconColor} size={20} />
                )}
                {!hiddenIcons.includes("user") && (
                    <CircleUserRound color={iconColor} size={20} />
                )}
